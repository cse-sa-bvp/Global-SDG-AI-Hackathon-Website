...
const EVENT_CITY = "Pune";
const EVENT_DATE = "25–27 September 2026";
...
export async function generateMetadata({ searchParams }: PageProps): Promise<Metadata> {
  ...
  const title = hasUser 
    ? `${userName} | Global SDG-AI Hackathon ${EVENT_CITY}`
    : `Generate Your Lanyard | Global SDG-AI Hackathon ${EVENT_CITY}`;
  
  const description = hasUser
    ? `${userName} is attending the Global SDG-AI Hackathon ${EVENT_CITY} - ${EVENT_DATE}. Join us for the event!`
    : `Create and customize your personalized Global SDG-AI Hackathon ${EVENT_CITY} event lanyard. Choose your color variant and download it as a high-resolution PNG.`;
  ...
  return {
    ...
    openGraph: {
      ...
      description,
      url: pageUrl,
      siteName: `Global SDG-AI Hackathon ${EVENT_CITY}`,
      type: "website",
      locale: "en_US",
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: `${userName} - Global SDG-AI Hackathon ${EVENT_CITY}`,
        },
      ],
    },
    twitter: {
      ...
      title,
      description,
      creator: "@global-sdg-ai-hackathon",
