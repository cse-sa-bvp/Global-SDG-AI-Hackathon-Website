...
// Bold Allura without stroke — use layered text-shadow to add weight
const alluraStyle = {
  ...gradientStyle,
  fontSize: "1.35em",
  lineHeight: 1.05,
  // Simulate weight with a subtle same-direction micro-shadow
  // Can't use WebkitTextStroke with gradient fill — it paints black
  filter: "drop-shadow(0px 0px 0.4px rgba(2, 132, 199, 0.6))",
} as const;
...
const features = [
  ...
  },
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
        <path d="M6 19c-2-4.5.5-11 10.5-13 1.4 6.6-1.5 11-6.5 12.5" stroke="#059669" strokeWidth="1.6" strokeLinejoin="round" />
  ...
  },
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
        <path d="M12 2.5c2.6 2 4 5.4 4 8.8 0 2-1 4.2-2.4 5.7l-1.6 1.7-1.6-1.7C9 15.5 8 13.3 8 11.3c0-3.4 1.4-6.8 4-8.8Z" stroke="#d97706" strokeWidth="1.6" strokeLinejoin="round" />
...
export default function WhyHackathonSection() {
  return (
    <SectionShell
      id="about"
      className="flex min-h-screen items-center overflow-hidden bg-[#FAFAF7] py-10 lg:py-12"
    >
      {/* Poppins wrapper — guaranteed to cascade regardless of SectionShell internals */}
      <div style={{ fontFamily: poppins.style.fontFamily }} className="w-full">
        <div className="grid w-full gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
           ...
           <h2 className="mt-3 text-4xl font-bold leading-[1.05] tracking-tight text-neutral-950 sm:text-5xl">
              AI with{" "}
              <span className={allura.className} style={alluraStyle}>
                Purpose.
              </span>
            </h2>
            <h2 className="mt-3 text-4xl font-bold leading-[1.05] tracking-tight text-neutral-950 sm:text-5xl">
            ...
            <p className="mt-4 max-w-xl text-pretty text-base leading-7 text-neutral-600 sm:text-lg">
              Artificial Intelligence is changing every industry, but real impact comes from solving meaningful
              problems. Build practical AI solutions aligned with the UN Sustainable Development Goals alongside
              mentors, innovators, and future changemakers.
            </p>
