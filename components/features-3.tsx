            ...
            <div className="@container mx-auto max-w-5xl px-6">
                <div className="text-center">
                    <TextEffect
                        ...
                        Join us for the Global SDG-AI Hackathon
                    </TextEffect>
                </div>
                <AnimatedGroup
                    triggerOnView
                    ...
                    <Card
                        ...
                        <div className="group shadow-zinc-950/5">
                            <CardHeader className="pb-3">
                                ...
                                <h3 className="mt-6 font-medium text-xl">Mentor Support</h3>
                            </CardHeader>

                            <CardContent>
                                <p className="text-sm text-muted-foreground">Guidance and live reviews to help teams move faster.</p>
                            </CardContent>
                        </div>
