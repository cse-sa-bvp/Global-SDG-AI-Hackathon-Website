                ...
                <div className="grid gap-y-12 px-2 lg:grid-cols-[1fr_auto]">
                    ...
                    >
                        <div className="pb-6">
                            ...
                            <p className="text-muted-foreground mt-4">A special welcome from the organizing team</p>
                        </div>
                        <div className="py-6">
                            <div className="font-medium space-x-2">
                            ...
                            <p className="text-muted-foreground mt-4">Hands on time to build your project with mentors nearby.</p>
                        </div>
                        <div className="py-6">
                            <div className="font-medium space-x-2">
